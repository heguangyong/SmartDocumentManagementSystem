...
public interface UserRepository extends JpaRepository<AppUser, Long> {
    ...
    // 根据邮箱查询用户
    Optional<AppUser> findByEmailAndLibraryCode(@Param("email") String email, @Param("libraryCode") String libraryCode);

    // 根据用户名查询用户
    Optional<AppUser> findByUsernameAndLibraryCode(@Param("username") String username, @Param("libraryCode") String libraryCode);
    ...
    // 根据统一用户UID查询用户
    Optional<AppUser> findByUidAndLibraryCode(@Param("uid") String uid, @Param("libraryCode") String libraryCode);

    // 判断统一用户UID是否存在
    boolean existsByUidAndLibraryCode(@Param("uid") String uid, @Param("libraryCode") String libraryCode);

    // 根据手机号查询用户
    Optional<AppUser> findByMobileAndLibraryCode(@Param("mobile") String mobile, @Param("libraryCode") String libraryCode);
